...
public class Ex13 {
	public static void main(String[] args) {
		// DataOututStream 과 DataInputStream
		// 기본자료형을 주고 받을 때 사용 (기본자료형을 읽고쓰는 메소드가 별도로 존재)
		// FileInputStream과 FileOutputStream과 다른 점은
		// 이진 데이터(0,1)를 입출력할때 사용한다.(타시스템과 입출력할때 유리)
		// ** 입력순서와 출력순서가 다르면 데이터의 결과가 달라질 수 있다.
		// BufferedInputStream과 BufferedOutputStream을 활용할수있다.
		...
		try {
			...
			System.out.println(dis.readChar()); //들어온 순서대로 안하면 깨짐
